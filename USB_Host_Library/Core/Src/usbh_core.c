...
#if (USBH_USE_OS == 1)
  OS_ERR  os_err;
  OSTaskQPost(&TaskUsbHostTCB,(void*)USBH_PORT_EVENT,1,OS_OPT_POST_FIFO,&os_err);
#endif  
  return USBH_OK;  
}
...
#if (USBH_USE_OS == 1)
      OS_ERR  os_err;
      OSTaskQPost(&TaskUsbHostTCB,(void*)USBH_STATE_CHANGED_EVENT,1,OS_OPT_POST_FIFO,&os_err);
#endif         
      }
    }
    break;
...
{
  OS_ERR  os_err;
  OSTaskQPost(&TaskUsbHostTCB,(void*)USBH_URB_EVENT,1,OS_OPT_POST_FIFO,&os_err);
  return USBH_OK;
}
